...
public interface DelphiListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DelphiParser#designator}.
	 * @param ctx the parse tree
	 */
	void enterDesignator(DelphiParser.DesignatorContext ctx);
	/**
	 * Exit a parse tree produced by {@link DelphiParser#designator}.
	 * @param ctx the parse tree
	 */
	void exitDesignator(DelphiParser.DesignatorContext ctx);
	/**
	 * Enter a parse tree produced by {@link DelphiParser#designatorItem}.
	 * @param ctx the parse tree
	 */
	void enterDesignatorItem(DelphiParser.DesignatorItemContext ctx);
	/**
	 * Exit a parse tree produced by {@link DelphiParser#designatorItem}.
	 * @param ctx the parse tree
	 */
	void exitDesignatorItem(DelphiParser.DesignatorItemContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link DelphiParser#colonConstruct}.
	 * @param ctx the parse tree
	 */
	void enterColonConstruct(DelphiParser.ColonConstructContext ctx);
	/**
	 * Exit a parse tree produced by {@link DelphiParser#colonConstruct}.
	 * @param ctx the parse tree
	 */
	void exitColonConstruct(DelphiParser.ColonConstructContext ctx);
	/**
	 * Enter a parse tree produced by {@link DelphiParser#operator}.
	 * @param ctx the parse tree
	 */
	void enterOperator(DelphiParser.OperatorContext ctx);
	/**
	 * Exit a parse tree produced by {@link DelphiParser#operator}.
	 * @param ctx the parse tree
	 */
	void exitOperator(DelphiParser.OperatorContext ctx);
	/**
